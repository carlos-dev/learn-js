...
export default function getSpeed(speed) {
  const tests = [
    [
      function (value) {
        return value <= value920cmn;
      },
      0,
    ],
    [
      between(value920cmn, value1038cmn),
      value920cmn,
    ],
    [
      between(value1038cmn, value1156cmn),
      value1038cmn,
    ],
    [
      
      between(value1156cmn, value1274cmn),
      value1156cmn,
    ],
    [
      
      between(value1274cmn, value1392cmn),
      value1274cmn,
    ],
    [
      
      between(value1392cmn, value1510cmn),
      value1392cmn,
    ],
    [
      
      between(value1510cmn, value1628cmn),
      value1510cmn,
    ],
    [
      
      between(value1628cmn, value1746cmn),
      value1628cmn,
    ],
    [
      
      between(value1746cmn, value1864cmn),
      value1746cmn,
    ],
    [
      function (value) {
        return value > value1864cmn;
      },
      value1864cmn,
    ],
  ];

  const [_, otherValue] = tests.find(([test]) => {
    return test(speed);
  });
